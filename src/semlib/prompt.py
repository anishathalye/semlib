...
async def prompt[T: BaseModel](
    prompt: str, /, *, return_type: type[T], model: str | None = None
) -> T: ...


@overload
async def prompt[T](
    prompt: str, /, *, return_type: Bare[T], model: str | None = None
) -> T: ...


@overload
async def prompt(
    prompt: str, /, *, return_type: None = None, model: str | None = None
) -> str: ...
